...
void GameManager::startGameLoop() {
    ...
    while (playAgain) {
        ...
        display->notifyMenuUpdate("1. Tic Tac Toe");
        display->notifyMenuUpdate("2. Connect Four");
        display->notifyMenuUpdate("3. Othello");
        display->notifyMenuUpdate("4. Draughts");
...
int GameManager::getModeChoice() {
    display->notifyInstructionsUpdate("Choisissez le mode de jeu:");
    display->notifyMenuUpdate("1. Joueur vs ordinateur");
    display->notifyMenuUpdate("2. Deux joueurs");
    display->notifyMenuUpdate("3. Ordinateur vs ordinateur ");
...
char GameManager::getReplayChoice() {
...
void GameManager::configurePlayers(int modeChoice, std::shared_ptr<Player>& player1, std::shared_ptr<Player>& player2) {;
    player1.reset();
    player2.reset();
